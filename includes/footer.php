<footer style="background: #020617; color: rgba(255,255,255,0.6); padding: 80px 0 30px;">
    <div class="container" style="text-align: center;">
        <img src="images/logo.png" alt="Logo" style="height: 55px; filter: brightness(0) invert(1); margin-bottom: 25px;">
        ...
        <div style="margin: 20px 0; font-size: 1.5rem;">
            ...
            <a href="#" style="color:#00c300; margin:0 10px;"><i class="fab fa-line"></i></a>
        </div>
        <p style="font-size: 0.8rem;">祥安生命有限公司 © <?php echo date("Y"); ?> 版權所有</p>
    </div>
</footer>

<?php include 'floating-cta.php'; ?>
...
<script>
    ...
    // 流星效果 (僅限有 hero-space 的頁面)
    const hero = document.getElementById('hero-space');
    if(hero) {
        setInterval(() => {
            ...
            ], { duration: 2500 }).onfinish = () => m.remove();
        }, 3000);
    }
</script>
